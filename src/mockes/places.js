...
const data = [
  {
    ...
    description: 'A Cachoeira Barra Azul oferece um refúgio de tranquilidade e beleza natural, com uma piscina na parte de baixo e uma vista espetacular na parte de cima. É um local perfeito para relaxar na natureza. É aconselhável levar lanches e bebidas. Com suas formações rochosas e mata circundante, a cachoeira oferece um espaço encantador para relaxar à beira d’água, adequado até para famílias com crianças.',
    whatsappNumber: 22,
    location: '-23.550520,-46.633308',
    YWF: [' Trilha | 1 Cachoeira | 1 Mirante'],
    promoterName: 'João Marcos',
    promoterPhone: '81998786543',
  ...
  
  {
    ...
    link: 'www.google.com',
    tag: 'praiaRelaxante',
    description: 'A Praia dos Carneiros é um paraíso tropical que cativa visitantes com sua extensão de areias douradas e mar calmo e claro. As águas mornas do oceano Atlântico banham a costa, proporcionando um ambiente propício para momentos relaxantes e atividades aquáticas. A praia é famosa por sua beleza natural intocada, com coqueiros que contornam a areia, criando uma atmosfera serena e tropical.',
    whatsappNumber: 22,
  ...
  },
  {
    ...
    link: 'www.google.com',
    tag: 'trilhasPraia',
    description: 'A trilha do Capim Açu é a mais longa do Parque Nacional Marinho de Fernando e Noronha e a que exige maior preparo físico do visitante.',
    whatsappNumber: 22,
  ...
  },
  {
    ...
    link: 'www.google.com',
    tag: 'trilhaBike',
    description: 'A trilha de bicicleta de Recife para Gravatá proporciona uma experiência única, permitindo aos ciclistas explorar as belezas naturais, culturais e históricas do interior de Pernambuco.',
    whatsappNumber: 22,
  ...
  },
  {
    ...
    link: 'www.google.com',
    tag: 'passeiobarco',
    description: 'Venha vivenciar a navegação das embarcações milenares do Triângulo Polinésio. A proposta da expedição é aventura e contemplação no cenário paradisíaco da Ilha de Fernando de Noronha.',
    whatsappNumber: 22,
  ...
  },
  {
    ...
    link: 'www.google.com',
    tag: 'passeiocatimbau',
    description: 'O Parque Nacional do Catimbau, também conhecido como Vale do Catimbau, é um parque nacional brasileiro do estado de Pernambuco. Criado em 22 de agosto de 2002, abrange os municípios de Buíque, Ibimirim, Sertânia e Tupanatinga, entre o Agreste e o Sertão pernambucano.',
    whatsappNumber: 22,
